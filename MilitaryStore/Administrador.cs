...
using LibreriaDLL;//libreria para hacer DataSet
...
namespace MilitaryStore
{
    public partial class Administrador : FormBase
    {
        ...
        {
            string consulta = "SELECT * FROM Usuarios WHERE id_usuario="+Login.Codigo;//traemos id_usuario almacenada en esa variable publica declarada en Login
            DataSet Data = Biblioteca.Herramientas(consulta);//la guardamos en la memoria catche
